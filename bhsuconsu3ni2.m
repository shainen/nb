...
randphase=RandomReal[{0,2\[Pi]},{Sites}];
...
sol=NDSolve[(eqns\[Nu]~Join~initials\[Nu])/.{U->Uvalue,\[Mu]->\[Mu]value,J->Jvalue,navg->navgvalue}~Join~Flatten[Table[Subscript[\[Nu], 0][m,n]->(\[Nu]varsingreek[[n]]/.{\[Alpha]->randinits[[m,1]],\[Beta]->randinits[[m,2]],\[Gamma]->randinits[[m,3]]}),{m,1,Sites},{n,1,8}]],Flatten[v\[Nu]],{t,0,tmax},MaxSteps->\[Infinity]
];
...
Save[su3outfile<>"spn3.lst",avgspins3]
Save[su3outfile<>"corn3.lst",avgcor3]
